...
(function(){
  ...
  function reordenarGrupos(sidebar){
    ...
    if(ordemManual&&ordemManual.length){
      ...
      comIndice=blocos.map(function(b,i){
        var score=b.chave==='biblioteca'?Infinity:(b.chave?(scores[b.chave]||0):0); // Minha Biblioteca sempre primeiro no modo automatico, nao depende de uso
        return{b:b,i:i,score:score};
      });
      comIndice.sort(function(a,b){if(b.score!==a.score)return b.score-a.score;return a.i-b.i});
    }
